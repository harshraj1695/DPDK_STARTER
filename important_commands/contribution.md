cat > CONTRIBUTION.md << 'EOF'
# CONTRIBUTION.md

## Contributing a New Example to DPDK (Step-by-Step)

This document explains how to contribute a new example to DPDK, starting from cloning the repository up to sending a patch to the mailing list.

It also includes common issues encountered during the process and how to fix them.
